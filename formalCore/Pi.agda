...
Π∙ : ∀ {Γ}(A : Ty ∙) → Ty (Γ ▶= A) → Ty Γ
Π∙ {Γ} A B = ty
  (λ x → ΣSP ((xx : ! A tt) → ! B (x , xx)) λ f →
              ∀ {xx₀ xx₁}(xx₀₁ : R A xx₀ xx₁ _)(xx₁₀ : R A xx₁ xx₀ _)
              → R B (f xx₀) (f xx₁) ((rfl Γ) , (xx₀₁ , xx₁₀)))
  (λ { {x₀}{x₁} (f , pf) (g , pg) x₀₁ →
       ∀ {xx₀}{xx₁}(xx₀₁ : R A xx₀ xx₁ _)(xx₁₀ : R A xx₁ xx₀ _)
       → R B (f xx₀) (g xx₁) (x₀₁ , xx₀₁ , xx₁₀)})
  ((λ { {x}{f , pf} {xx₀}{xx₁} xx₀₁ xx₁₀ → pf xx₀₁ xx₁₀}))
  (λ { {x₀}{x₁}{x₂} {x₀₁}{x₁₂} {f , f~}{g , g~}{h , h~} fg gh {xx₀}{xx₂} xx₀₂ xx₂₀ →
       trs B (fg xx₀₂ xx₂₀) (gh (rfl A) (rfl A))})
  (λ { {x₀}{x₁} x₀₁ (f , f~) →
         (λ xx → coeT B (x₀₁ , (rfl A , rfl A)) (f xx))
       , λ { {xx₀}{xx₁} xx₀₁ xx₁₀ → coeT-rec B (trs B (f~ xx₀₁ xx₁₀) (cohT B _ (f xx₁)))}})
  (λ { {x₀}{x₁} x₀₁ (f , f~) {xx₀}{xx₁} xx₀₁ xx₁₀ → trs B (f~ xx₀₁ xx₁₀) (cohT B _ (f xx₁))})
  (λ { {x₀}{x₁}{x₂}{x₀₁}{x₁₂}{ff₀ , ff₀~}{ff₂ , ff₂~} ff₀₂ {xx₁}{xx₂} xx₁₂ xx₂₁
       → coeT-rec B (ff₀₂ xx₁₂ xx₂₁)})
